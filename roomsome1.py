...
def get_price(hotel_config, arrive, departure):
    ...
    full_post_url = f"http://api.scraperapi.com?api_key={scraperapi_key}&url={encoded_post_url}"
    ...
    return f"Első POST válasz első 1000 karaktere:\n{response_post.text[:1000]}"
